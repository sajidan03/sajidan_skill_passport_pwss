...
<body>
                    ...
                    <div class="card-body">
                        <form method="post">
                            <div class="form-group pt-2">
                                ...
                                <input type="date" class="form-control" id="date" placeholder="Masukkan tanggal" name="tanggal">
                            </div>
                            <div class="form-group pt-2">
                                <label for="productName">Nama Produk</label>
                                <input type="text" class="form-control" id="productName" placeholder="Masukkan nama produk" name="produk">
                            </div>
                            <div class="form-group pt-2">
                            ...
                            <div class="form-group pt-2">
                                ...
                                <input type="number" class="form-control" id="quantity" placeholder="Masukkan jumlah produk" name="jml_beli">
                            </div>
    ...
    if (isset($_POST['tambah'])) {
        ...
        $query = mysqli_query($koneksi, "INSERT INTO transaksi (tanggal, produk, harga, jml_beli) values ('$tanggal', '$produk', '$harga', '$jml')");
        if ($query) {
